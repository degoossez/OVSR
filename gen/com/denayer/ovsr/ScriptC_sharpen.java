 ...
 * @hide
 */
public class ScriptC_sharpen extends ScriptC {
    private static final String __rs_resource_name = "sharpen";
    // Constructor
    public  ScriptC_sharpen(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_sharpen(RenderScript rs, Resources resources, int id) {
