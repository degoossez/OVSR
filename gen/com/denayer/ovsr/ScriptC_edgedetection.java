 ...
 * The source Renderscript file: /home/dries/git/OVSR/src/com/denayer/ovsr/edgedetection.rs
 */
 ...
 * @hide
 */
public class ScriptC_edgedetection extends ScriptC {
    private static final String __rs_resource_name = "edgedetection";
    // Constructor
    public  ScriptC_edgedetection(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_edgedetection(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportVarIdx_filterC = 3;
    private float[] mExportVar_filterC;
    public synchronized void set_filterC(float[] v) {
        mExportVar_filterC = v;
        FieldPacker fp = new FieldPacker(36);
        for (int ct1 = 0; ct1 < 9; ct1++) {
            fp.addF32(v[ct1]);
        }

        setVar(mExportVarIdx_filterC, fp);
    }

    public float[] get_filterC() {
        return mExportVar_filterC;
    }
